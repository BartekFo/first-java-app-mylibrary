...
public class Utils {
    ...
    private static final String CURRENTLY_TO_READ_BOOKS = "currently_reading_books";
...
//    private static ArrayList<Book> favoriteBooks;
    ...
    private Utils(Context context) {
        ...
        if (null == getCurrentlyReadingBooks()) {
            editor.putString(CURRENTLY_TO_READ_BOOKS, gson.toJson(new ArrayList<Book>()));
            editor.commit();
        }
    ...
    public ArrayList<Book> getCurrentlyReadingBooks() {
        Gson gson = new Gson();
        Type type = new TypeToken<ArrayList<Book>>(){}.getType();
        ArrayList<Book> books = gson.fromJson(sharedPreferences.getString(CURRENTLY_TO_READ_BOOKS, null), type);
        return books;
    }
    ...
    public boolean addToCurrentlyReading(Book book) {
        ...
        if (null != books) {
            if (books.add(book)){
                Gson gson = new Gson();
                SharedPreferences.Editor editor = sharedPreferences.edit();
                editor.remove(CURRENTLY_TO_READ_BOOKS);
                editor.putString(CURRENTLY_TO_READ_BOOKS, gson.toJson(books));
                editor.commit();
                return true;
            }
        }
